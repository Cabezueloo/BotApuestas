...
def getNameEvent(soupUFC): return soupUFC.find('h2',{'class': "text-xl md:text-2xl text-center font-bold text-tap_3"}).text if soupUFC.find('h2',{'class': "text-xl md:text-2xl text-center font-bold text-tap_3"}) == True else " "
